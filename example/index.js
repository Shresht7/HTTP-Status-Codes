//  Library
import { Status, StatusCode, isStatus, isError, isInformation, StatusText } from '../HTTPStatusCodes.js'
...
console.log('StatusText(StatusCode.BAD_GATEWAY)', StatusText(StatusCode.BAD_GATEWAY))
